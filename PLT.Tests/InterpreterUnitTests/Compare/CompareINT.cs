...
namespace PLT.Tests.InterpreterUnitTests
{
    public class CompareIntTest
    {
        private bool[] CreateInterpreter(string op, string type)
        {
            ...
            interpreter.SetIntAccumulator1(3);
            interpreter.SetIntAccumulator2(2);

            method?.Invoke(interpreter, [type]);
            bool result1 = interpreter.GetRLO();

            interpreter.SetIntAccumulator1(3);
            interpreter.SetIntAccumulator2(3);

            method?.Invoke(interpreter, [type]);
            bool result2 = interpreter.GetRLO();

            interpreter.SetIntAccumulator1(3);
            interpreter.SetIntAccumulator2(4);
        ...
        {
            bool[] result = CreateInterpreter("LEQ", "D"); 
        ...
        {
            bool[] result = CreateInterpreter("GEQ", "D");
        ...
        {
            bool[] result = CreateInterpreter("LT", "D");
        ...
        {
            bool[] result = CreateInterpreter("GT", "D");
        ...
        {
            bool[] result = CreateInterpreter("NEQ", "D");
        ...
        {
            bool[] result = CreateInterpreter("EQ", "D");
